...
insert into public.polymarket_tracked (category, label, search_query, event_id, event_slug, event_title, sort_order) values
  ('CRYPTO',      'BTC',   'what price will bitcoin hit in',  'pending-btc',   '', 'BTC Price Prediction',       0),
  ('COMMODITIES', 'OIL',   'crude oil hit june',              'pending-oil',   '', 'Oil Price Prediction',       1),
  ('EQUITIES',    'SPX',   'sp500 spx hit june',              'pending-spx',   '', 'S&P 500 Level Prediction',   2),
  ('MACRO',       'RATES', 'how many fed rate cuts 2026',     'pending-rates', '', 'Fed Rate Cuts 2026',         3);
