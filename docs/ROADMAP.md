...
- [ ] **[code-quality] Oversized route files (>400 LOC) — remaining** — `/page.tsx` (521). Apply the same pattern as consult + calendar: lift presentational components into `features/<name>/components/`, pure helpers into `features/<name>/lib/`, types into `features/<name>/types.ts`. _(found tick 28, carved out tick 31; dashboard done tick 38 — 127 LOC; plan/archive done tick 39 — 179 LOC; watchlist done tick 40 — 151 LOC; plan/compare done tick 44 — 145 LOC; remaining: /page.tsx 521)_
