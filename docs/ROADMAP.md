...
- [ ] **[code-quality] Oversized route files (>400 LOC)** — `/app/calendar/page.tsx` (1011), `/app/page.tsx` (774), `/app/plan/archive/page.tsx` (724), `/app/watchlist/page.tsx` (573), `/page.tsx` (521), `/app/plan/compare/page.tsx` (494). Same pattern as the now-split consult page: lift presentational components into `features/<name>/components/`, pure helpers into `features/<name>/lib/`, types into `features/<name>/types.ts`. Calendar is the biggest and the natural next victim. _(found tick 28)_
