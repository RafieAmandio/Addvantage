...
export function BackToTop({
  ...
  return (
    <button
      ...
      title="Back to top"
      className={cn(
        "fixed bottom-6 left-6 z-[55] flex items-center gap-2 border border-lime/60 bg-gray-2 px-3 py-2 font-mono text-[10px] uppercase tracking-widest2 text-lime shadow-[0_0_30px_rgba(245,158,11,0.15)] transition-all",
        visible
