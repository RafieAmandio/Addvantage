export default function ConsultLoading() {
  return (
    <div className="min-h-screen bg-black flex flex-col">
      <div className="animate-pulse border-b border-gray-3 px-6 py-4 flex items-center gap-3">
        <div className="h-2 w-2 rounded-full bg-gray-2" />
        <div className="h-4 w-32 rounded bg-gray-2" />
      </div>
      <div className="flex-1 px-6 py-8 space-y-6 max-w-3xl w-full mx-auto animate-pulse">
        {/* AI message */}
      ...
      <div className="animate-pulse border-t border-gray-3 px-6 py-4">
