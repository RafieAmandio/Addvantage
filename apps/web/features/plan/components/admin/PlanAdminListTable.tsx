    ...
    <div className="space-y-px bg-gray-3">
      {plans.map((p) => (
        <Link
          ...
          className="group grid grid-cols-12 items-center gap-6 bg-black p-5 transition-all hover:-translate-y-px hover:bg-gray-2 focus-visible:ring-1 focus-visible:ring-brand focus-visible:outline-none"
        >
          <div className="col-span-12 lg:col-span-2">
            ...
            <div className="mt-2 flex gap-2 font-mono text-[9px] uppercase tracking-widest2">
              <span className={cn(
                p.bias === "bullish" ? "text-moss" : p.bias === "bearish" ? "text-blood-bright" : "text-white/70",
              )}>
                {p.bias ?? p.direction}
              </span>
